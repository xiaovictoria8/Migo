...
def process_workers(worker_dict, output_writer, qual_workers_writer, non_qual_workers_writer):
    ...
    for workerId in worker_dict:
        ...
        if stat_list[0] >= 16 and stat_list[2] > 0.8:
            qual_workers_writer.writerow([workerId, stat_list[0], stat_list[1], stat_list[2], stat_list[3], stat_list[4], stat_list[5], diff_stats[0], diff_stats[1], diff_stats[2], stat_list[6], stat_list[7], stat_list[8]])
...
def main():
    ...
    qual_workers_writer.writerow(["workerID", "completed_HITs", "correct_HITs", "HIT_correctness_rate", "initial_precision", "initial_recall", "initial_f1", "initial_precision_difference_from_baseline", "initial_recall_difference_from_baseline", "initial_f1_difference_from_baseline", "final_precision", "final_recall", "final_f1"])
